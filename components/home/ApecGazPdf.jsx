  ...
  return (
    <Document>
      <Page size={customPageSize} style={styles.mainScan3}>
        <Image src={"/assets/png&jpg/apecGaz.png"} style={styles.svg} />
