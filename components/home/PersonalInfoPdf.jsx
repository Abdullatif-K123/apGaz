  ...
  return (
    <Document>
      <Page size={customPageSize} style={styles.mainScan3}>
        <Image src={"/assets/png&jpg/apeWhite.png"} style={styles.svg} />
          ...
          <View style={styles.peronalSocial3}>
            <View>
              <View style={styles.iconBorder3}>
                <Image
                  src="/assets/png&jpg/instgram.png"
            ...
            <View>
              <View style={styles.iconBorder3}>
                <Image
                  src="/assets/png&jpg/facebook.png"
                  style={styles.socialIcon3}
                />
              </View>
            </View>
            ...
            <View>
              <View style={styles.iconBorder3}>
                <Image
                  AllowDangerousPaths
                  src="/assets/png&jpg/linkedIn.png"
                  style={styles.socialIcon3}
                />
              </View>
            </View>
      ...
      <Page size={customPageSize} style={{ backgroundColor: "#c11821" }}>
